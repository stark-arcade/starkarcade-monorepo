...
import { CreateGameProcessor } from './processors/createGame.processor';
...
@Module({
  ...
  providers: [Web3Service, GameItemService, UserService, CreateGameProcessor],
})
export class CreateGameQueueModule {}
